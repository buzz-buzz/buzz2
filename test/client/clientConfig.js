angular.module("clientConfigModule", []).value("clientConfig", {
    "cdn": "",
    "captcha": {"host": "uat.bridgeplus.cn", "port": "10001"},
    "serviceUrls": {
        "sso": {
            "profile": {
                "load": {
                ...
                "update": {"frontEnd": "/service-proxy/sso/profile/update", "upstream": "/profile/update"},
                "changePassword": {
                    "frontEnd": "/service-proxy/sso/password/change",
                    "upstream": "/profile/changepassword"
                },
                "changeMobile": {"frontEnd": "/service-proxy/sso/mobile"}
            },
            "signIn": {"frontEnd": "/service-proxy/sso/sign-in", "upstream": "/logon/authentication"},
            "signUp": {"frontEnd": "/service-proxy/sso/sign-up", "upstream": "/member/register"},
            "resetPassword": {"frontEnd": "/service-proxy/sso/password/reset", "upstream": "/member/resetPassword"}
        },
        "sms": {
            "sendWithCaptcha": {"frontEnd": "/service-proxy/sms/send", "upstream": "/service/sms/send"},
            "validate": {"upstream": "/service/sms/validate"}
        },
        "buzz": {
            "profile": {
                "education": {
            ...
            "courses": {
                ...
                "findByLevel": {"frontEnd": "/service-proxy/buzz/courses/:level", "upstream": "/courses/:level/true"},
                "findByDate": {
                ...
                "search": {"frontEnd": "/service-proxy/buzz/search-courses", "upstream": "/courses"}
            },
            "categories": {"list": {"frontEnd": "/service-proxy/buzz/categories", "upstream": "/courses/categories"}},
            "courseViews": {
            ...
            "quiz": {
                "result": {
                    ...
                    "upstream": {"save": "/quiz/save_result", "get": "/quiz/get_result"}
                },
                "resultGroup": {
                    "frontEnd": "/service-proxy/buzz/quiz/result-group",
                    "upstream": {"save": "/quiz/save_result_group"}
                },
            ...
            "share": {"myLink": "/service-proxy/share/my-link"},
            "progress": {
                "statistics": {
            ...
            "weekly": {"getScore": {"frontEnd": "/service-proxy/weekly/score", "upstream": "/weekly-quiz"}}
        },
        "wechat": {"sign": {"frontEnd": "/service-proxy/wechat/sign", "upstream": "/sign/buzz"}}
    }
});